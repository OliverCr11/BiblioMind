                                        ...
                                        <>
                                            ...
                                            <div className="py-1">
                                                ...
                                                {currentUser?.is_staff && (
                                                    <a href={`${import.meta.env.VITE_API_URL}/admin/`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 text-sm text-brand border-l-2 border-transparent hover:border-brand hover:bg-brand/5 hover:text-white transition-colors">
