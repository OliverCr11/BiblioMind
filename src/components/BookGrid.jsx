                        ...
                        <div key={book.id} className="book-card h-[450px] w-full group cursor-pointer">
                            <div className="book-card-inner relative w-full h-full rounded-2xl shadow-2xl">
                                ...
                                <div className="book-card-front bg-card flex flex-col items-center">
                                    <img src={book.coverURL} alt={book.title} className="w-full h-full object-cover border border-white/5 rounded-2xl" />
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="flex items-center gap-1 mb-6">
                                            {[...Array(5)].map((_, i) => (
                                                <Star
                                                    key={i}
                                                    className={`h-4 w-4 ${i < Math.floor(book.rating) ? 'text-brand fill-brand glow-primary' : 'text-gray-600'}`}
                                                />
                                            ))}
                                            <span className="ml-2 text-sm text-gray-300 font-bold">{book.rating}</span>
                                        </div>
